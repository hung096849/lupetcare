                                ...
                                <div class="book-form">
                                    <div class="book-form-service">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <label for="phoneNumber" class="pt-4 pb-2 book-form-text">Số điện thoại
                                                    *</label>
                                                <input type="text" name="phone" required class="form-control input-form-service">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                <label for="Name " class="pt-4 pb-2 book-form-text">Email của bạn
                                                    *</label>
                                                <input type="text" name="email" required class="form-control input-form-service">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="time" id="datetimepicker5" name="time"
                                                    value="{{ old('time')}}" class="form-control input-form-service">
                                            </div>
                                            <div class="col-md-6">
