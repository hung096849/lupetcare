            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-8" style="padding:30px;">
                        ...
                        <a href="{{ route('backend.admin.services.show') }}" class="btn btn-primary float-left">Quay lại danh sách</a>
                    </div>
                </div>
            </div>
            <!-- /.container-fluid -->
                    ...
                    <div class="card card-primary">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <label for="">anh</label>
                                <p><img src="{{ asset('storage/Service_image/' .  $services->image) }}" alt="" style="width: 100px"></p>
                                <label for="">Gia</label>
                                <p>{{ $services->price}}</p>
