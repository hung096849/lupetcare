...
<div class="wrapper">
    ...
    <div class="content-wrapper" style="min-height: 1602px;">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6" style="padding:30px;">
                        <h1 class="float-left mr-5"><i class="nav-icon fas fa-address-book"></i>Thêm bài viết</h1>
                    </div>
                </div>
            </div>
            <!-- /.container-fluid -->
        ...
        <section class="content">
            <form method="POST" enctype="multipart/form-data" action="{{ route('backend.admin.news.store') }}">
                {{--  --}}
                @csrf
                <div class="row">
                    <div class="col-12">
...
>>>>>>> 3900516 (tin tuc)
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="detail" id="detail" class="form-control" placeholder="" ></textarea>
                                    @error('detail')
                                    <div class="mt-1 text-red-500">
                                        {{$message}}
                                    </div>
