                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-8" style="padding:30px;">
                            <h1 class="float-left mr-5"><i class="nav-icon fas fa-user"></i> Chi tiết quyền</h1>
                            <a href="" class="btn btn-success float-left mr-2"><i class="fas fa-edit"></i> Sửa</a>
                            <a href="{{ route('backend.admin.permissions.delete', $permissions->id) }}" class="btn btn-danger float-left mr-2"><i class="fas fa-edit"></i> Xóa</a>
                        </div>
                    </div>
                </div>
                <!-- /.container-fluid -->
