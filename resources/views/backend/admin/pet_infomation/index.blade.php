                            ...
                            <div class="card-header">
                                <div class="card-tools">
                                    <div class="input-group input-group-sm" style="width: 150px;">
                                        ...
                                        data-url="{{ route('backend.admin.petinformation.search') }}" class="form-control float-right" placeholder="Tìm kiếm">
                                ...
                                <table class="table table-hover text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Số thứ tự</th>
                                            <th>@sortablelink('name', 'Tên thú cưng')</th>
                                            <th>@sortablelink('code', 'Mã thú cưng')</th>
                                            <th>Hành động</th>
                                        </tr>
                                    </thead>
                                    <tbody id="search-data">
                                        @include('backend.admin.pet_infomation.search')
                                    </tbody>
                                </table>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <div class="dataTables_paginate paging_simple_numbers float-right" id="example2_paginate">
                            @include('backend.components.pagination', ['paginator' => $petInfomations])
                        </div>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
