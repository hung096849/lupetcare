            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-8" style="padding:30px;">
                        <h1 class="float-left mr-5"><i class="nav-icon fas fa-address-book"></i> Tin Nhắn</h1>
                            ...
                            <div class="card-header">
                                <div class="card-tools">
                                    <div class="input-group input-group-sm" style="width: 150px;">
                                        ...
                                        data-url="{{ route('backend.admin.sms.search') }}"
                                ...
                                <table class="table table-hover text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Số thứ tự</th>
                                            <th>@sortablelink('name', 'Khách hàng')</th>
                                            <th>@sortablelink('phone', 'Số điện thoại')</th>
                                            <th>Hành động</th>
                                        </tr>
                                    </thead>
                                    <tbody id="search-data">
                                        @include('backend.admin.sms.search')
                                    </tbody>
                                </table>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <div class="dataTables_paginate paging_simple_numbers float-right" id="example2_paginate">
                            @include('backend.components.pagination', ['paginator' => $sms])
                        </div>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
